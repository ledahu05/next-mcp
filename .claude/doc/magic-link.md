...
RESEND_FROM_EMAIL="onboarding@resend.dev"  # Domaine de test Resend
ADMIN_EMAIL="votre-email@example.com"       # Votre email admin
NEXT_PUBLIC_APP_URL="http://localhost:3000"
```

**Note** : Le domaine de test Resend (`onboarding@resend.dev`) permet d'envoyer des emails uniquement vers l'email du compte Resend. Pour la production, il faudra vérifier un domaine.
...
-   Si magic link expiré : l'utilisateur doit refaire une demande complète
